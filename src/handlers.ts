...
import { InstallmentRepo } from "./installment/repo";
...
const installmentRepo = new InstallmentRepo(pool);
...
export const getAllInstallments = getAll(installmentRepo);
export const getInstallmentById = getById(installmentRepo);